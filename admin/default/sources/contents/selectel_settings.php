            ...
            <form enctype="multipart/form-data" method="post" id="storageSettings">
                ...
                <div class="i_general_row_box_item flex_ tabing_non_justify">
                    ...
                    <div class="irow_box_right column flex_">
                        <input type="text" name="selectelEndpoint" class="i_input flex_" placeholder="https://s3.ru-1.storage.selcloud.ru" value="<?php echo iN_HelpSecure($selectelEndpoint ?? 'https://s3.ru-1.storage.selcloud.ru'); ?>">
                        <div class="rec_not box_not_padding_left"><?php echo iN_HelpSecure($LANG['selectel_endpoint_not'] ?? 'Default: https://s3.ru-1.storage.selcloud.ru (region ru-1)'); ?></div>
                    </div>
                </div>
