(function ($) {
  ...
  function share(social, url, id) {
    ...
    const shareWindows = {
      ...
      vk: `https://vk.com/share.php?url=${encodedURL}&title=${encodedContent}&image=${image}`,
      vkontakte: `https://vk.com/share.php?url=${encodedURL}&title=${encodedContent}&image=${image}`,
      telegram: `https://t.me/share/url?url=${encodedURL}&text=${encodedContent}`,
      odnoklassniki: `https://connect.ok.ru/offer?url=${encodedURL}&title=${encodedContent}&imageUrl=${image}`,
