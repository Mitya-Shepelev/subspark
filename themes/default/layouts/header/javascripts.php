...
<script src="<?php echo $baseThemePath; ?>/js/jquery.form.js?v=<?php echo iN_HelpSecure($version); ?>"></script>
...
<?php if ($logedIn == 1): ?>
  ...
  <script src="<?php echo $baseThemePath; ?>/js/upchunk.min.js?v=<?php echo iN_HelpSecure($version); ?>" defer></script>
